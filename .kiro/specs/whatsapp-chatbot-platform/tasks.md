...
- [ ] 0. Establish row-level multi-tenancy, context resolution, and per-tenant storage
  - [ ] 0.1 Create `tenants`, `tenant_users`, `tenant_usage` migrations and Eloquent models with backed enums (`TenantStatus`, `QuotaKind`)
